   			...
   			<div class="container" id="attendance" style="width:100%">
   				<div class="row justify-content-center">
   					<div class="col-md-6 text-center mb-5">
   						<center>
   							<div style="margin-top:2%; margin-bottom:2% ;color:blue;font-size:25px;" class="name" id="hospital_name"></div>
   						</center>
   						<center>
   							<div style="margin-bottom:2% ;color:red;font-size:18px ;font-weight: bold;font-style: italic;" class="name" id="hospital_remarks"></div>
   						</center>
   					</div>
   				</div>
   				<div class="row">
   						...
   						<div class="content w-100">
   							<div class="calendar-container">
   								<div class="calendar">
   									...
   									<button id="add-button" class="button">Book Appointment</button>
   								</div>
   							</div>
